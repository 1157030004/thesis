  ...
  eat(obstacle) {
    ...
    for (var i = 0; i < obstacle.length; i++) {
      var d = dist(
        this.position.x,
        this.position.y,
        obstacle[i].position.x,
        obstacle[i].position.y
      );
      angleTwo = this.position.angleBetween(obstacle[i].position);
      ...
      console.log(record);
      if (record < this.perceptionRadius && angleTwo < this.perceptionAngle) {
        diff = p5.Vector.sub(this.position, obstacle[i].position);
